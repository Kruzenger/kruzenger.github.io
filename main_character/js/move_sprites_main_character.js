...
function moving() {
	if ((me_run == ON && side == RIGHT && me_jamp == OFF && shield_up == OFF) && (length_of_walk <= 600 || npc_talked == ON || npc_angry == ON)) {
		length_of_walk += 2;
	...
	else if ((shifting == ON && side == RIGHT && me_jamp == OFF && shield_up == OFF) && (length_of_walk <= 600 || npc_talked == ON || npc_angry == ON)) {
		length_of_walk += 9;
		BG_Xposition -= 9; 
		enemy_position1 -= 9;
		enemy_position2 -= 9; 
		...
		if ((run_right == ON) && (length_of_walk <= 600 || npc_talked == ON || npc_angry == ON)) {
