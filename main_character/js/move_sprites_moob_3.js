...
function atack3(){
	if (enemy_side3 == RIGHT && stun3 == OFF) {
...
function is_moob_alive3(){
	if (health_of_enemy3 <= 0) {
		...
		setTimeout(function(){
			enemy_position3 = 1000;
			enemy3.style.left = enemy_position3 + 'px';
			enemy_atack3 = OFF;
			stun3 = OFF;
			enemy3.style.opacity = '1';
		}, 1000);
		health_of_enemy3 = 100;
		health_of_enemy_width3 = 100;
		enemy_health3.style.width = health_of_enemy3 + 'px';
	}
