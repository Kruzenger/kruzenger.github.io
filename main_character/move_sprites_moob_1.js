...
var enemy_dead_right_X = 1250;
var enemy_dead_left_X = 1100;
const enemy_dead_Y = 750;
...
function moob_is_dead1(){
	dead1 = 1;
	if (side == 1) {
		enemy1.style.backgroundPositionX = '-' + enemy_dead_left_X + 'px';
		enemy1.style.backgroundPositionY = '-' + enemy_dead_Y + 'px';

		if (enemy_dead_left_X == 200) {
			enemy_dead_left_X = 1250;
			enemy1.style.opacity = '0';
			setTimeout(function(){enemy1.style.top = '0px'}, 3000);
		}
		else{
			enemy_dead_left_X -= 150;
			setTimeout(moob_is_dead1, 100);
		}
	}
	else{
		enemy1.style.backgroundPositionX = '-' + enemy_dead_right_X + 'px';
		enemy1.style.backgroundPositionY = '-' + enemy_dead_Y + 'px';

		if (enemy_dead_right_X == 2150) {
			enemy_dead_right_X = 1250;
			enemy1.style.opacity = '0';
			setTimeout(function(){enemy1.style.top = '0px'}, 3000);
		}
		else{
			enemy_dead_right_X -= 150;
			setTimeout(moob_is_dead1, 100);
		}
	}
}